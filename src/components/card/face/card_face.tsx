  ...
  return (
      <div classList={{
        ...
        <div classList={{
          ...
          [styles.fairy]: props.face.foreground === CardForegroundType.Fairy,
          [styles.spider]: props.face.foreground === CardForegroundType.Spider,
          [styles.dragon]: props.face.foreground === CardForegroundType.Dragon,
        }}>
